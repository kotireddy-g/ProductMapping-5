...
import { Search, Mic, Plus, CheckCircle2, ChevronRight, Loader2, AlertTriangle } from 'lucide-react';
        ...
        const fetchHomeData = async () => {
            ...
            try {
                ...
                if (res?.success && res?.data) {
                    ...
                    // Sort by priority before storing
                    const sorted = [...(res.data.actions || [])].sort((a, b) => a.priority - b.priority);
                    setActions(sorted);
                } else {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center px-6 pt-20 pb-12">
                ...
                {/* Error state */}
                {error && (
                    <div className="w-full max-w-2xl mb-6 flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-xl text-sm text-red-600">
                    ...
                    <div className="w-full max-w-2xl">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {actions.map((action) => (
                                <button
                                    key={action.id}
                                    onClick={() => onActionClick && onActionClick(action.id, action.label)}
